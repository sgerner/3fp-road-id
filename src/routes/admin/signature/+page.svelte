...
<div class="mx-auto w-full max-w-6xl px-4 py-6 md:py-8">
	<div class="overflow-hidden rounded-[2rem] border border-white/10 bg-surface-950/70 shadow-2xl shadow-black/20">
		<div class="border-b border-white/10 bg-gradient-to-br from-surface-950 via-surface-900 to-primary-950/40 px-6 py-6 md:px-8">
		...
		<div class="grid gap-6 px-6 py-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8">
			<section class="space-y-4">
				...
				<div class="card preset-tonal-surface border-white/10 p-5">
					<div class="space-y-3">
						<div class="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-surface-950/70 px-4 py-3">
			...
			<section class="space-y-4 lg:sticky lg:top-6 lg:self-start">
				<div class="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-xl shadow-black/10">
