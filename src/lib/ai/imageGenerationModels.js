...
export const SOCIAL_IMAGE_GENERATION_MODELS = Object.freeze([
	...
	{
		id: IMAGE_GENERATION_MODEL_IDS.GEMINI_31_FLASH_IMAGE,
		label: 'Gemini'
	}
]);
...
export function normalizeSocialImageGenerationModelId(value) {
	...
	const normalized = replacement || candidate;
	return SOCIAL_IMAGE_GENERATION_MODELS.some((option) => option.id === normalized)
		? normalized
		: '';
}
