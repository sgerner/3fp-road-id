---
title: Victim Resource Template
description: 
published: true
date: 2025-03-03T23:15:52.411Z
tags: 
editor: markdown
dateCreated: 2025-03-03T05:27:21.145Z
---
...
1. **Ensure your safety first** - Move to sidewalk or safe area if possible
2. **Get medical help** - Call 911 if you're injured (even minor injuries can worsen)
...
4. **Collect driver information** (if applicable):
   - Name, phone number, address
   - Driver's license number
   - Vehicle make/model/license plate
   - Insurance company and policy number
5. **Report the incident** even if it seems minor
6. **Seek medical attention** even if injuries seem minor (some injuries become apparent later)
