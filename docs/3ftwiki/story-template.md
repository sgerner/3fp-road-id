...
1. **Online Form:** Complete our [case study submission form](https://forms.gle/8phnsovqM93P2yc3A).
2. **Email:** Send your story to [hi@3feetplease.org](mailto:hi@3feetplease.org).
3. **Direct Wiki Submission:** Create a page directly on our wiki by following these steps:
   - Create an account.
   - Navigate to [Create a Page](https://learn.3feetplease.org/e/en/new-page).
