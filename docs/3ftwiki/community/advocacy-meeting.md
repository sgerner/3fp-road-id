...
1. **Shared Understanding:** Officials clearly understand the specific request and supporting rationale
2. **Documented Concerns:** Both community and official concerns are acknowledged and recorded
3. **Commitment:** Secure specific commitments to next steps with timeline
4. **Relationship Building:** Strengthen working relationships between community advocates and officials
5. **Clear Accountability:** Establish how progress will be monitored and reported
6. **Expanded Support:** Engage new advocates and expand your coalition
...
- [ ] Identify key decision-makers and their positions/concerns on the issue
- [ ] Reach out to officials to schedule the meeting
- [ ] Begin outreach to potential community participants
...
- [ ] Assign specific roles to planning team members
- [ ] Hold a strategy session with key community participants
- [ ] Conduct additional outreach, especially to associated non-cyclists groups
- [ ] Gather relevant data, photos, maps, and supporting evidence
...
- [ ] Prepare sign-in sheets and materials
- [ ] Finalize visual aids and handouts
- [ ] Confirm logistics (room setup, AV needs, accessibility)
- [ ] Brief any subject matter experts or special participants
- [ ] Prepare media talking points

# INVITING OFFICIALS

## Which Officials to Invite
...
## Core Components of Your Presentation
...
4. Document commitments: "To confirm, you're committing to [specific action] by [specific date]. Is that correct?"
...
- [ ] Share outcomes with your broader membership/community
- [ ] Post appropriate updates on social media
...
- [ ] Plan appropriate public communication strategy
...
- [ ] Update your membership and coalition partners
- [ ] Document progress and setbacks
- [ ] Plan escalation strategies if commitments aren't kept
...
**THE REQUEST:**
_1-2 sentence specific request to officials_
...
Effective bicycle advocacy with city officials requires focus, preparation, and persistence. By narrowing your request to a specific policy, project, or geographic area, you make it easier for officials to understand, respond to, and ultimately implement your proposals.
