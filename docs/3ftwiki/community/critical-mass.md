...
# Steps to Planning an Effective Critical Mass Ride
...
## 4. Establish Coordination Methods
...
## 6. Pre-Ride Gathering & Orientation
...
## 7. Establish a Positive Interaction Philosophy
...
- [ ] Research local laws and previous Critical Mass dynamics in your area
- [ ] Identify experienced cyclists who can serve as informal facilitators
- [ ] Create simple promotional materials with basic information
...
- [ ] Prepare simple handouts explaining Critical Mass etiquette for newcomers
- [ ] Connect with experienced Critical Mass participants to help welcome first-timers
...
- [ ] Facilitate informal introductions among participants
- [ ] Check that bikes have lights if the ride will extend into evening
- [ ] Discuss the general ride approach and communication methods
...
- [ ] Monitor the group's energy and suggest adjustments as needed
- [ ] Document the ride through photos and videos when possible
- [ ] Model positive interactions with other road users
...
- [ ] Share information about local cycling advocacy efforts
- [ ] Collect contact information from those interested in future rides
- [ ] Share photos and stories through established channels
- [ ] Begin planning for next month's ride

# Equipment & Supplies Checklist for Facilitators
...
- [ ] Whistle or loud bell for attention when needed
- [ ] Printed cards with Critical Mass information to share with curious onlookers
- [ ] Local cycling maps to share with newcomers
