---
title: Complete Streets Hub
description: 
published: true
date: 2025-03-04T03:32:17.675Z
tags: 
editor: markdown
dateCreated: 2025-03-02T00:59:28.546Z
---

# Resident's Guide to Safer, Accessible Neighborhoods

> Complete Streets policies ensure roadways are designed for *everyone*—pedestrians, cyclists, transit riders, and drivers—providing safe, comfortable, and accessible public spaces.
{.is-success}
...
- [Sample Action Plan](/policies/complete-streets/action-plan) with an Itemized To-Do List
- [Marketing Plan](/policies/complete-streets/marketing-plan) a detailed to-do list aligned in phases with the action plan.
- [Model Council Resolutions & Policies](/policies/complete-streets/resolutions) for establishing Complete Streets in your locality
- Guide to [Building a Compelling Case](/policies/complete-streets/briefing)
- The [Policy Audit Template](/policies/complete-streets/policy-audit) provides a structure for assessing the strength of existing policies
- [Sample Letters to Council](/policies/complete-streets/council-letters)
- [Marketing Assets Templates](/policies/complete-streets/marketing-assets) to easily modify for your local campaign
- [Sample Op-Eds](/policies/complete-streets/op-eds)

> Check out the [Missouri Livable Streets Advocacy Manual](https://www.mocompletestreets.com/wp-content/uploads/2021/01/fa762-website-ready-advocacy-manual-3_4.pdf) for even more resources. Livable Streets is another phrase for Complete Streets.
{.is-success}
...
> The vision of Complete Streets policies ensures a safe, equitable, and connected transportation network, prioritizing accessibility for all users, especially underserved populations.
{.is-info}
...
> Prioritizing underserved communities in Complete Streets policies ensures equitable access to safe and effective transportation for all.
{.is-info}
...
> Complete Streets policies should apply to *all* transportation projects to ensure every street is safe and accessible for all users.
{.is-info}
...
> Effective Complete Streets policies require collaboration between departments within a locality and local, state, and regional agencies to ensure consistency and effectiveness.
{.is-info}
...
> Streets should be designed to match the unique needs of each community, balancing safety, accessibility, and local context.
{.is-info}
...
> Measuring progress with safety, accessibility, and equity metrics ensures Complete Streets policies achieve their intended impact.
{.is-info}


> **STOP & ASSESS:** Before going further, holistically assess your town or city on each of the metrics above using the [Policy Audit Template](/policies/complete-streets/policy-audit). Understanding where you're already thriving and opportunities for improvement will help you in this process. You will need to tailor your messaging and the actual Complete Street policy based on the needs of your community.
{.is-warning}
...
- Review our [Guide for Building a Case](/policies/complete-streets/case-study) for tips.
- **Assess the Benefits:** Use a tool like the [Benefits of Complete Streets Tool](https://benefits.completestreets.org/) to help understand the positive impact a Complete Streets Policy will have in your community
...
*   **Complete Street Ordiance:** The first step is usually for your Council to adopt a [Complete Streets resolution](/policies/complete-streets/resolutions).
*   **Updated design guidelines and standards:**  Make sure your city's [engineering standards reflect Complete Streets principles](/policies/design-standards).
...
*   **Use resources from organizations like Smart Growth America's [Complete Streets Guidelines](https://smartgrowthamerica.org/program/national-complete-streets-coalition/policy-atlas/policy-development/)**
...
- [Complete streets - Wikipedia](https://en.wikipedia.org/wiki/Complete_streets#:~:text=Complete%20streets%20is%20a%20transportation,1)
- [Complete Streets - Smart Growth America](https://smartgrowthamerica.org/what-are-complete-streets/#:~:text=Complete%20Streets%20are%20streets%20for,of%20all%20ages%20and%20abilities)
- [City Health - Efficacy of Complete Streets](https://www.cityhealth.org/resource-center/efficacy-of-complete-streets/#:~:text=Complete%20Streets%20should%20be%20the,Streets%20as%20the%20modus%20operandi)
-	[Smart Growth America - Milwaukee Complete Streets](https://smartgrowthamerica.org/milwaukee-wi-capacity-challenges-slow-but-dont-stall-complete-streets-work/#:~:text=match%20at%20L147%20strong%20local,to%20improve%20safety%20on%20them)
- [Planning.org - Benefits of Complete Streets](https://www.planning.org/planning/2024/aug/complete-streets-drive-housing-jobs-and-retail-gains/#:~:text=projects%20smartgrowthamerica,3%2C500%20lives%20over%20three%20decades)
- [Tri-State Transportation - Complete Streets Promote Good Health](https://tstc.org/reports/licsbx/cs-health.pdf#:~:text=Walkability%20has%20a%20direct%20and,or%20obese%20than%20similar%20people)
- [Missouri Complete Streets](https://www.mocompletestreets.com/)
- [New Orleans Complete Streets Coalition](https://nolacompletestreets.org/)
